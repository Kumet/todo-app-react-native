...
export const EditTaskScreen: FC<Props> = ({navigation}) => {
    const {editedTask, updateTask, updateErr, onChangeTask, resetInput} = useEditTask({navigation})
    return (
        <SafeAreaView style={tw('flex-1 bg-gray-100')}>
            ...
            <IconButton name="edit" color="gray" size={20} onPress={updateTask}/>
            {updateErr !== '' && (
